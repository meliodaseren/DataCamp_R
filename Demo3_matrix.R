...
box_office2 <- c(5.0, 6.0, 7.0, 4.0, 4.5, 4.9,
                 5.0, 6.0, 7.0, 4.0, 4.5, 4.9)
ticket_prices_matrix <- matrix(box_office2, nrow = 6, byrow = FALSE,
...
avg_us_visitros = mean(us_visitors)
avg_us_visitros
